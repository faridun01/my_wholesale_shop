                ...
                <div className="mt-5 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-2xl bg-slate-50 p-4">
                      <p className="text-xs uppercase tracking-[0.12em] text-slate-400">Продуктивность</p>
                      <p className="mt-2 text-3xl font-semibold text-slate-900">{stats.completionRate}%</p>
                    </div>
                    <div className="rounded-2xl bg-rose-50 p-4">
                      <p className="text-xs uppercase tracking-[0.12em] text-rose-400">Просрочено</p>
                      <p className="mt-2 text-3xl font-semibold text-rose-500">{stats.overdue}</p>
                    </div>
                  </div>
                </div>
              </div>
