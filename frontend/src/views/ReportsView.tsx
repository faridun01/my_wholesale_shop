      ...
      <div className="space-y-4 lg:space-y-5 lg:rounded-[28px] lg:bg-[#f4f5fb] lg:p-5 min-h-screen">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold tracking-tight text-slate-900">Отчёты и аналитика</h1>
          ...
          <div className="flex items-center gap-2">
            {reportType === 'profit' && (
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl border border-slate-200/80 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-xs transition-colors hover:bg-slate-50"
              >
                <TrendingUp size={14} />
                <span>Аналитика</span>
              </button>
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border border-slate-200/80 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-xs transition-colors hover:bg-slate-50 disabled:opacity-40"
            >
              <FileSpreadsheet size={14} />
              <span>{isExcelExporting ? 'Экспорт...' : 'Excel'}</span>
            </button>
            <button
              onClick={handleExportReport}
              disabled={isExporting || !reportData.length}
              className="flex items-center gap-1.5 rounded-xl bg-slate-900 px-3.5 py-2 text-xs font-semibold text-white shadow-xs transition-colors hover:bg-slate-800 disabled:opacity-40"
            >
              <FileText size={14} />
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-3.5 shadow-xs space-y-3">
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex flex-wrap items-center gap-1 rounded-full border border-slate-200 bg-slate-100/70 p-1 shadow-xs">
              {[
            ...
            <div className="flex flex-wrap items-center gap-2 xl:justify-end">
              {/* Quick Presets */}
              <div className="flex items-center gap-0.5 rounded-xl border border-slate-200 bg-slate-100/70 p-0.5">
                {[
                  ...
                  <button
                    ...
                    className="rounded-lg px-2.5 py-1 text-[11px] font-semibold text-slate-600 transition-colors hover:bg-white hover:text-slate-900 hover:shadow-xs"
                  >
                    {preset.label}
                  </button>
                ))}
